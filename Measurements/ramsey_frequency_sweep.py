...
scheme = 'ramsey'
file_tag_prefix = 'ramsey_frequency_sweep'
work_dir = set_up_measurement(scheme, measurement_tag=file_tag_prefix, settings_file='hardwarefile',
...
for f in NV_IF_freq_array:
    file_tag = file_tag_prefix + f'_f{str(f*1e-6).replace(".", ",")}MHz'
